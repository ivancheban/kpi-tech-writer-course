...
* Go to the Telegram [official website](https://telegram.org/) or watch the latest versions list [below](#supported-systems) and choose the platform to install the application.
* Download and install the app, following the instructions.
* Open the app. Register a new account or log in your current one.
* If you get some troubles, visit Telegram [FAQ page](https://telegram.org/faq) and search a solve or use the [support block](https://telegram.org/faq#telegram-support).

## Supported systems

* Mobile applications:
  * [Android](https://telegram.org/dl/android/apk)
  * [iPhone](https://apps.apple.com/app/telegram-messenger/id686449807) or [iPad](https://apps.apple.com/app/telegram-messenger/id686449807)
* Desktop versions:
...
Telegram apps are open source and support reproducible builds. It means that anyone can independently verify that Telegram apps downloaded from App Store or Google Play were built using the exact same code published.
...
You can contribute translating of Telegram applications by following the [webpage](https://translations.telegram.org/).
